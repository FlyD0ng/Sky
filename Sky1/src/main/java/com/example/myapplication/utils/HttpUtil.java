...
import com.example.myapplication.AthenaApplication;
...
public class HttpUtil {
    ...
    static {
        mOkHttpClient = new OkHttpClient().newBuilder().connectTimeout(5, TimeUnit.SECONDS).writeTimeout(5, TimeUnit.SECONDS)
